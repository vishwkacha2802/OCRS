# Generated by Django 4.1.6 on 2023-05-01 14:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('accounts', '0026_delete_police_incharge'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incharge_id', models.AutoField(primary_key=True, serialize=False, unique=True)),
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='police_incharge_groups', related_query_name='police_incharge', to='auth.group', verbose_name='groups')),
                ...
                ('station_name', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='complaints.police_station_master')),
